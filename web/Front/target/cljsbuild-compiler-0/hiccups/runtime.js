...
var _STAR_html_mode_STAR_16410 = hiccups.runtime._STAR_html_mode_STAR_;
hiccups.runtime._STAR_html_mode_STAR_ = mode;

try{return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_16410;
}});
/**
...
hiccups.runtime.render_attribute = (function hiccups$runtime$render_attribute(p__16411){
var vec__16415 = p__16411;
var name = cljs.core.nth.call(null,vec__16415,(0),null);
var value = cljs.core.nth.call(null,vec__16415,(1),null);
if(value === true){
if(cljs.core.truth_(hiccups.runtime.xml_mode_QMARK_.call(null))){
 ...
 */
hiccups.runtime.normalize_element = (function hiccups$runtime$normalize_element(p__16418){
var vec__16425 = p__16418;
...
var tag = first__16427;
var content = seq__16426__$1;
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else {
}

var vec__16428 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));
var _ = cljs.core.nth.call(null,vec__16428,(0),null);
var tag__$1 = cljs.core.nth.call(null,vec__16428,(1),null);
var id = cljs.core.nth.call(null,vec__16428,(2),null);
var class$ = cljs.core.nth.call(null,vec__16428,(3),null);
...
var vec__16434 = hiccups.runtime.normalize_element.call(null,element);
var tag = cljs.core.nth.call(null,vec__16434,(0),null);
var attrs = cljs.core.nth.call(null,vec__16434,(1),null);
var content = cljs.core.nth.call(null,vec__16434,(2),null);
if(cljs.core.truth_((function (){var or__6409__auto__ = content;
